    ...
    <main className="min-h-screen bg-[#121212]">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        <h1 className="text-4xl font-bold text-center mb-4">
          Club <span className="text-sadrc-orange">Constitution</span>
        </h1>
        <div className="max-w-4xl mx-auto bg-[#1a1a1a] p-8 rounded-lg mt-8">
          <div className="prose prose-invert max-w-none">
            <h2 className="text-2xl font-bold mb-4 text-sadrc-orange">Rules of Skegness and District Running Club</h2>
            ...
            <div className="mt-12 pt-8 border-t border-gray-700">
              <p className="text-gray-400">This is a summary of key sections from our constitution. For the complete document or any specific queries, please contact our Club Secretary.</p>
              <div className="mt-4 flex gap-4">
                <button
                  onClick={handleDownload}
                  className="flex items-center gap-2 px-4 py-2 bg-sadrc-orange text-white rounded hover:bg-orange-600 transition-colors"
                >
                  <FaDownload />
